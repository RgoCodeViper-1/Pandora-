...
impl Default for EngineConfig {
    fn default() -> Self {
        EngineConfig {
            ...
            fixed_strings:        false,
            whole_line:           false,
            // scoring knobs // Note: The following are already present inside engine.rs EngineRuntime at line 102.
            min_confidence:       0.6, // already in use in engine.rs under EngineRuntime at line 102
            multi_intent:         true,
            max_intents:          8, // already in use in engine.rs under EngineRuntime at line 102
            wakeword:             Some("pandora".to_string()), // already in use in engine.rs under EngineRuntime at line 102
            strip_wakeword:       true,
            heap_limit:           None,
        }
    }
